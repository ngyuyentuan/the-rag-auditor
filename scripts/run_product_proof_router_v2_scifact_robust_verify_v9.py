...
def main():
    ...
    ap.add_argument("--grid_points", type=int, default=41)
    ...
    lines.append("runtime mitigation: thresholds were fit on fit_n subsample; feature_map built with parquet filter on qid_set; robust verify metrics are computed from n=200 runs per seed/budget")
    lines.append("")
