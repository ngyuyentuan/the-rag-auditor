...
| metric | value | 95% CI |
|---|---:|---:|
| uncertain_rate | 0.3630 | [0.3340, 0.3940] |
| fp_accept_rate | 0.0010 | [0.0000, 0.0040] |
| fn_reject_rate | 0.0460 | [0.0340, 0.0600] |
| ok_rate | 0.9530 | [0.9390, 0.9660] |
| coverage | 0.6370 | [0.6060, 0.6660] |
| accuracy_on_decided | 0.9262 | [0.9051, 0.9462] |
...
```
scripts/eval_stage1_product.py --track fever --in_path /mnt/c/Users/nguye/Downloads/My projject/the-rag-auditor/data/calibration/fever_stage1_dev_train.parquet --logit_col logit_platt --y_col y --tuned_thresholds_yaml configs/thresholds_stage1_tuned_fever.yaml --n 1000 --out_md reports/stage1_product_eval_fever.md
```
