...
|---|---|---|---|---|---|---|---|---|---|---|---|
| baseline_candidate | 0.6095 | 0.7792 | 0.8009 | 0.5155 | 352 | 48 | 0.1287 | 0.6553 | PASS | N/A | ok |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 0.6095 | 0.7792 | 0.8009 | 0.5155 | 352 | 48 | 0.1287 | 0.6553 | PASS | N/A | 0.8550 |
...
- coverage: `0.5154639175257731`
- accept_count: `352`
- reject_count: `48`
- fp_given_accept_upper95: `0.12873739747081533`
- fn_given_reject_upper95: `0.6552890998421254`
- accuracy_on_decided: `0.855`

Repro command

```
scripts/stage1_action_ci_tune.py --track scifact --in_path /mnt/c/Users/nguye/Downloads/My projject/the-rag-auditor/data/calibration/scifact_stage1_dev_train.parquet --logit_col raw_max_top3 --y_col y --n 1000 --seed 14 --certify accept_only --min_accept_count 200 --min_coverage 0.30 --max_fp_given_accept_upper95 0.15 --out_md reports/stage1_action_ci_tune_scifact_accept.md --out_yaml configs/thresholds_stage1_action_accept_scifact.yaml
```
